...
export const enter = async ({ amountSushi, wallet, provider, connector, sushiCategory, xSushiCategory, sushiBarCategory, }) => {
    return enterOrLeave({
        enter: true,
        amount: amountSushi,
        wallet,
...
export const leave = async ({ amountXSushi, wallet, provider, connector, sushiCategory, xSushiCategory, sushiBarCategory, }) => {
    return enterOrLeave({
        enter: false,
        amount: amountXSushi,
        wallet,
...
export const enterOrLeave = async ({ enter, amount, wallet, provider, connector, sushiCategory, xSushiCategory, sushiBarCategory, }) => {
    if (amount <= 0n) {
