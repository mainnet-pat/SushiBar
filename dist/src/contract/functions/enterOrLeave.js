import { placeholderP2PKHUnlocker, TransactionBuilder } from "cashscript";
import { binToHex, TokenSendRequest } from "mainnet-js";
...
export const enter = async ({ amountSushi, wallet, provider, connector, sushiCategory, xSushiCategory, sushiBarCategory, tokenNames = {
    sushiName: "Sushi",
    xSushiName: "xSushi",
...
export const leave = async ({ amountXSushi, wallet, provider, connector, sushiCategory, xSushiCategory, sushiBarCategory, tokenNames = {
    sushiName: "Sushi",
    xSushiName: "xSushi",
    sushiBarName: "SushiBar",
}, }) => {
...
export const enterOrLeave = async ({ enter, amount, wallet, provider, connector, sushiCategory, xSushiCategory, sushiBarCategory, tokenNames = {
    sushiName: "Sushi",
    xSushiName: "xSushi",
    sushiBarName: "SushiBar",
}, }) => {
    ...
    let what;
    let newCommitment;
    let inputTokenCategory;
    let outputTokenCategory;
    if (enter) {
...
//# sourceMappingURL=enterOrLeave.js.map